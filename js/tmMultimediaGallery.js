			...
			var object = $(this),
				...
				getObject = {
					...
					constructor: function (params) {
						...
						function init(){
							...
							object
								.on('showGallery', function(e, d){
									...
									getObject.next.addClass('showButton');
									getObject.prev.addClass('showButton');
								...
								.on('hideGallery',function(e){
									...
									getObject.next.removeClass('showButton');
									getObject.prev.removeClass('showButton');
						...
						// function for go to d(parameter) element
						function goTo(e, d, q){
							if (d){
								d = parseInt(d);
						...
						function descriptionChange(){
							description
								...
								.eq(currImg)
									.addClass(getObject.descriptionActiveClass);
						}
						...
						function clickPagination(e, d){
							if (!mouseDrag) {
								if($(this).parent().index()!=currImg && loadComplete){
									...
									prevImg<currImg?dragDirection=1:dragDirection=-1;
				        ...
				        function resizeElement(obj) {
				        	if (obj.length) {
								...
								var imageWidth = obj.width(),
									...
									imageDeltaX = 0,
									imageDeltaY = 0,
									alignIMG = obj.attr('data-image-align') ? obj.attr('data-image-align') : getObject.alignIMG,
